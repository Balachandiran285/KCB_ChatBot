...
/*--------------------------------------------------------------------------------------------------------------------------------*/
	 ...
	 $(document).ready(function(){
	    ...
	    $(document).on('mouseenter','.ratting-container span', function(){
		 ...
		 $(document).on('mouseleave','.ratting-container', function(){
			 $('.ratting-container span').removeClass('hovered')
		 })
	...
	$rootScope.getclientIp=function(){
  	...
  	$rootScope.gotoBot = function(textLocation, botTitleName,  botname,persistentMenu, welcomeMessage,botchaticon, userchaticon, botBgImg, profainityValue){  		
  		...
  		if(navigator.cookieEnabled==false){
  			...
  			if(localStorage.getItem("SETCHANNELID"+$rootScope.mybotname )==null || localStorage.getItem("SETCHANNELID"+$rootScope.mybotname)=="" || localStorage.getItem("SETCHANNELID"+$rootScope.mybotname)== undefined){
  	  			
  	            localStorage.setItem("SETCHANNELID"+$rootScope.mybotname,genRandomDigit(Constants.CHANNELID_LENGTH));
  	            Value.config.channelid = localStorage.getItem("SETCHANNELID"+$rootScope.mybotname);
  	 		}else{
